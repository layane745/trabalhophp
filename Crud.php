...
class Crud{
    ...
    public function update($id,$nome,$idade,$email){
        ...
        if($sql->execute()){
            echo 'Registro Atualizado! <br><a href="updateDados.php">Voltar</a>';
        }else{
            echo 'Problemas ao tentar atualizar registro! <br><a href="updateDados.php">Voltar</a>';
        }
    ...
    public function delete($id,){
        ...
        if($sql->execute()){
            echo 'Registro Deletado! <br><a href="deleDados.php">Voltar</a>';
        }else{
            echo 'Problemas ao tentar deletar registro! <br><a href="deleDados.php">Voltar</a>';
        }
